...
(function(root, factory) {
    ...
    // --- MAPI Property Types ---
    // These constants represent the data types of MAPI properties.
    ...
    // --- MAPI Property IDs ---
    // These are common MAPI property IDs used to extract standard email fields.
    ...
    function parseAddress(addr) {
        ...
        if (email.indexOf('@') === -1) {
            email = null; // It's just a display name, no email
        } else {
            ...
            mimeData.to.split(/[;,]/).forEach(function(addrStr) {
                ...
                if (parsed.email) {
                    ...
                    if (recipientMap[key]) {
                        ...
                        console.log('Updating recipient from MIME (To):', parsed.email);
            ...
            mimeData.cc.split(/[;,]/).forEach(function(addrStr) {
                ...
                if (parsed.email) {
                    ...
                    if (recipientMap[key]) {
                        ...
                        console.log('Updating recipient from MIME (Cc):', parsed.email);
