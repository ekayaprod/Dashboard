...
* **`msg-reader.js`**: The core binary parser module. Exporting `MsgReader`, which handles the low-level decoding of `.msg` arrays.
...
Do not import `msg-reader.js` directly into the main thread. Always communicate via the worker:
